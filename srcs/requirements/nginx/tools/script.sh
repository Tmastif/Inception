...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout nginx-selfsigned.key -out nginx-selfsigned.crt -subj "/C=MA/ST=NA/L=NA/O=ilazar/OU=42/CN='$DOMAIN_NAME'"
